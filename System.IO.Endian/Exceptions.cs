...
namespace System.IO.Endian
{
    internal static class Exceptions
    {
        ...
        public static ArgumentOutOfRangeException ParamMustBePositive(string paramName, object paramValue) => new ArgumentOutOfRangeException(paramName, paramValue, Utils.CurrentCulture($"The {paramName} value must be greater than zero."));
        public static ArgumentOutOfRangeException ParamMustBeNonNegative(string paramName, object paramValue) => new ArgumentOutOfRangeException(paramName, paramValue, Utils.CurrentCulture($"The {paramName} value must be non-negative."));
        ...
        public static ArgumentOutOfRangeException OutOfStreamBounds(string paramName, object value) => new ArgumentOutOfRangeException(paramName, value, Utils.CurrentCulture($"The {paramName} value is out of bounds. The value must be non-negative and no greater than the length of the underlying stream."));
